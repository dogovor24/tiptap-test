		...
		<editor-menu-bar :editor="editor">
			<div class="menubar" slot-scope="{ commands, isActive }">
				<div class="toolbar">
					...
					<button
						class="menubar__button"
						:class="{ 'is-active': isActive.textAlign({align: 'left'}) }"
					...
					<button
						class="menubar__button"
						:class="{ 'is-active': isActive.textAlign({align: 'center'}) }"
					...
					<button
						class="menubar__button"
						:class="{ 'is-active': isActive.textAlign({align: 'right'}) }"
...
<script>
	...
	export default {
		...
		data() {
            ...
            <p style="text-align: right;"> asd
              Tables come with some useful commands like adding, removing or merging rows and columns. Navigate with <code>tab</code> or arrow keys. Resizing is also supported.
            </p>
            <p>
            	test <span data-npa="123">some NPA</span> some
            </p>
            <table>
              <tr>
